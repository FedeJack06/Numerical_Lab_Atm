...
% P. Oddo
% --------------------------------------------------
 model_path='/Users/poddo/Courses/Numerical_Ocean_lab/Exercises/model_results/OVERFLOW';
 model_re_t='OVF_zps_FCT4_flux_ubs_grid_T.nc';
...
% ----------------
 figure('Position',[10 10 600 1000]);
   ...
   colormap(a,[m_colmap('jet',256)]);caxis([10 22]);
%
...
%
print -dpng Ex4_figure.png;close;
